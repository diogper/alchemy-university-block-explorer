# Introduction
This is my implementation of the third module week project: Ethereum of the Alchemy University Ethereum Course.

The Leet Block Explorer has unique styling and supports fetching block numbers, its transactions and getting wallet balances.

Note: Can eventually be used on a local blockchain, with a local provider.
